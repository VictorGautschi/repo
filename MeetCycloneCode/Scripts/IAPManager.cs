...
public class IAPManager : MonoBehaviour, IStoreListener
{
    ...
    public Button restoreRemoveAdsButton;
...
#else 
    public static string PRODUCT_NO_ADS = "com.vormikestudios.MeetCyclone.remove_ads";
#endif
    ...
    private void Awake()
    {
        ...
        levelManager = LevelManager.Instance();         onShopCanvas = OnShopCanvas.Instance();
    }
    ...
    private void Update()     {         // It will only disable the buttons if the restorePurchases has not been checked.          if (searchCheck == true && !GameControl.control.purchasesRestoredChecked)         {             if (priceText.text == "Searching...")             {                 removeAdsButton.gameObject.SetActive(false);                 restoreRemoveAdsButton.gameObject.SetActive(false);             }             else             {                 removeAdsButton.gameObject.SetActive(true); #if UNITY_IOS                 restoreRemoveAdsButton.gameObject.SetActive(true); #endif                 searchCheck = false;             }         }     }
